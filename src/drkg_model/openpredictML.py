...
if __name__ =="__main__":
    ...
    parser.add_argument('-ff', required=True, dest='feature_folder', help='enter path to feature folder ')
    parser.add_argument('-g', required=True, dest='goldind', help='enter path to gold standard data ')

    args= parser.parse_args()
    
    rel_path = args.feature_folder
    goldindfile = args.goldind
    ...
    drugfeatfiles = [ 
                     '/Users/elifozkan/Desktop/translator-openpredict/data/drkg/feature_related/output/drug-ppi-sim.csv', 
                     "/Users/elifozkan/Desktop/translator-openpredict/data/drkg/feature_related/output/drugs-se-sim.csv", 
                     "/Users/elifozkan/Desktop/translator-openpredict/data/drkg/feature_related/output/drugs-TARGETSEQ-sim.csv", 
                     "/Users/elifozkan/Desktop/translator-openpredict/data/drkg/feature_related/output/drugs-tc-sim.csv"]
    diseasefeatfiles =["/Users/elifozkan/Desktop/translator-openpredict/data/drkg/feature_related/output/disease-hpo.csv", 
                        '/Users/elifozkan/Desktop/translator-openpredict/data/drkg/feature_related/output/disease-pheno.csv' ]

    '''

    drugfeatfiles = ["/Users/elifozkan/Desktop/translator-openpredict/data/baseline_features/drugs-fingerprint-sim.csv", 
                     '/Users/elifozkan/Desktop/translator-openpredict/data/baseline_features/drugs-ppi-sim.csv', 
                     "/Users/elifozkan/Desktop/translator-openpredict/data/baseline_features/drugs-se-sim.csv", 
                     "/Users/elifozkan/Desktop/translator-openpredict/data/baseline_features/drugs-target-go-sim.csv", 
                     "/Users/elifozkan/Desktop/translator-openpredict/data/baseline_features/drugs-target-seq-sim.csv"]
    diseasefeatfiles =["/Users/elifozkan/Desktop/translator-openpredict/data/baseline_features/diseases-hpo-sim.csv", 
                        '/Users/elifozkan/Desktop/translator-openpredict/data/baseline_features/diseases-pheno-sim.csv' ]
    '''


    #goldindfile = '../data/input/openpredict-omim-drug.csv'
    drugDiseaseKnown = pd.read_csv("/Users/elifozkan/Desktop/translator-openpredict/data/drkg/feature_related/output/drug-disease-indications.csv") 
    drugDiseaseKnown = drugDiseaseKnown.drop_duplicates()
    drugDiseaseKnown.head()

    drugDiseaseKnown.rename(columns={'SubjectID':'Drug','ObjectID':'Disease'}, inplace=True)
   ...
   #graphURI = URIRef('http://bio2rdf.org/openpredict_resource:bio2rdf.output.openpredict.R1')
    ...
    os.mkdir('results')
    outfile ='/Users/elifozkan/Desktop/translator-openpredict/src/drkg_model/results_disjoint_lr.nq'
