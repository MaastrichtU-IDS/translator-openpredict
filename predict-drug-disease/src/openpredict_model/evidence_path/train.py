...
def percentiles_of_different_features():
    ...
    for feature in features_drug :
        ...
        f'{get_openpredict_dir()}embedding/feature_specific_embeddings_KG/feature_FeatureTypesDrugs.' + str(feature) + '.txt', binary=False)
    ...
    for feature in features_diseases :
        ...
        f'{get_openpredict_dir()}embedding/feature_specific_embeddings_KG/feature_FeatureTypesDiseases.' + str(feature) + '.txt', binary=False)
