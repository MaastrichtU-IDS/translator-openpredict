...
if __name__ =="__main__":
    #python generateDiseaseFeatures.py -hpo data/input/omim-disease-hpo.csv -mesh data/external/mim2mesh.tsv -di data/input/openpredict-omim-drug.csv -t ../temp -a /Users/remzicelebi/Desktop/Current/workspace/openpredict/
    ...
    disease_hpo = pd.read_csv(os.path.join(abs_path, args.hpo_annotation))
    disease_hpo.head()
    ...
    with open(os.path.join(abs_path, args.mesh_annotation)) as meshfile:
        ...
        for line in meshfile:
            ...
            di = line[0]
            if int(di) not in gold_diseases: continue
            mesh = line[1:]
            mesh_ann[di]=mesh
            #print (di,':', mesh)
